...
<?php
				...
				while ($row = mysql_fetch_row($res)) 
				{
					...
					<tr class="<?php echo $bg;?>">
						...
						<td align="center">| <a href="<?php echo $root;?>&amp;act=edit&amp;id=<?php echo $id;?>">Edit</a> || 
							<a href="<?php echo $root;?>&amp;act=del&amp;id=<?php echo $id;?>" onclick="return confirm('Delete data with id 
							<?php echo $id; echo " (".$row[1]. " )"; ?>  ?');" > Hapus</a> |
